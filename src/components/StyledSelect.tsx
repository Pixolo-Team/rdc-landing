    ...
    <div className="w-full">
      ...
      <div className="relative">
        ...
        <button
          ...
          ref={btnRef}
          type="button"
          className="w-full text-left bg-transparent border-b border-n-800 py-3 text-n-900 text-sm focus:outline-none focus:border-sky-500 flex justify-between items-center disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        >
          <span
            ...
            className={`truncate text-xl text-n-900 ${selected ? "text-n-900" : "text-n-500"} lg:max-w-[300px] xl:max-w-[450px] 2xl:max-w-[580px]`}
          >
